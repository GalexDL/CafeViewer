...
function NormalSkin() {
    ...
    if (option.models.value == "CharaP0202_00.skel"){
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0202_50/CharaP0202_50.skel"){
        setNewCostume("CharaP0202_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0202a_00/CharaP0202a_00.skel"){
        setNewCostume("CharaP0202_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0202a_50/CharaP0202a_50.skel"){
        setNewCostume("CharaP0202_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
...
function Skin1() {
    setNewCostume("/CharaP0202_50/CharaP0202_50.skel");
    setTimeout(function() {
...
function SNormalSkin() {
    setNewCostume("/CharaP0202a_00/CharaP0202a_00.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
function SSkin1() {
    setNewCostume("/CharaP0202a_50/CharaP0202a_50.skel");
    setTimeout(function() {
        setDefaultSkin("ClerkCostume");
    }, 300);
}
