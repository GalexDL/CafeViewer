...
function NormalSkin() {
    ...
    if (option.models.value == "CharaP0175_00.skel"){
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0175_50/CharaP0175_50.skel"){
        setNewCostume("CharaP0175_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0175a_00/CharaP0175a_00.skel"){
        setNewCostume("CharaP0175_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0175a_50/CharaP0175a_50.skel"){
        setNewCostume("CharaP0175_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
...
function Skin1() {
    setNewCostume("/CharaP0175_50/CharaP0175_50.skel");
    setTimeout(function() {
...
function SNormalSkin() {
    setNewCostume("/CharaP0175a_00/CharaP0175a_00.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
function SSkin1() {
    setNewCostume("/CharaP0175a_50/CharaP0175a_50.skel");
    setTimeout(function() {
        setDefaultSkin("ClerkCostume");
    }, 300);
}
