...
function NormalSkin() {
    ...
    if (option.models.value == "CharaP0136_00.skel"){
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0136_08/CharaP0136_08.skel"){
        setNewCostume("CharaP0136_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0136_09/CharaP0136_09.skel"){
        setNewCostume("CharaP0136_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
...
function Skin1() {
    setNewCostume("/CharaP0136_08/CharaP0136_08.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
...
function Skin2() {
    setNewCostume("/CharaP0136_09/CharaP0136_09.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
