...
//
function NormalSkin() {
    if (option.models.value == "/CharaP0052_05/CharaP0052_05.skel"){
        setNewCostume("CharaP0052_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0052_50/CharaP0052_50.skel"){
        setNewCostume("CharaP0052_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "CharaP0052_00.skel"){
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
...
function Meowth22() {
    setNewCostume("/CharaP0052_05/CharaP0052_05.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
...
function MeowthMY() {
    setNewCostume("/CharaP0052_50/CharaP0052_50.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
