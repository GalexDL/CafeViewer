...
function NormalSkin() {
    ...
    if (option.models.value == "CharaP0149_00.skel"){
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0149_50/CharaP0149_50.skel"){
        setNewCostume("CharaP0149_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0143_51/CharaP0143_51.skel"){
        setNewCostume("CharaP0149_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
...
function Skin1() {
    setNewCostume("/CharaP0149_50/CharaP0149_50.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
...
function Skin2() {
    setNewCostume("/CharaP0143_51/CharaP0143_51.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
