...
function NormalSkin() {
    ...
    if (option.models.value == "CharaP0129_00.skel"){
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0129a_00/CharaP0129a_00.skel"){
        setNewCostume("CharaP0129_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
...
function SMagikarp() {
    setNewCostume("/CharaP0129a_00/CharaP0129a_00.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
