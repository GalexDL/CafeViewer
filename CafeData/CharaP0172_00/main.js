...
function NormalSkin() {
    ...
    if (option.models.value == "CharaP0172_00.skel"){
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0172_50/CharaP0172_50.skel"){
        setNewCostume("CharaP0172_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
...
function Skin1() {
    setNewCostume("/CharaP0172_50/CharaP0172_50.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
