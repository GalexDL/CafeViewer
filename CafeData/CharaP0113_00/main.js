...
function NormalSkin() {
    ...
    if (option.models.value == "CharaP0113_00.skel"){
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0113_13/CharaP0113_13.skel"){
        setNewCostume("CharaP0113_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
...
function ChanseySE() {
    setNewCostume("/CharaP0113_13/CharaP0113_13.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
