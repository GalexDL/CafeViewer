...
function NormalSkin() {
    ...
    if (option.models.value == "CharaP0135_00.skel"){
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0135_08/CharaP0135_08.skel"){
        setNewCostume("CharaP0135_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0135_10/CharaP0135_10.skel"){
        setNewCostume("CharaP0135_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
...
function Skin1() {
    setNewCostume("/CharaP0135_08/CharaP0135_08.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
...
function Skin2() {
    setNewCostume("/CharaP0135_10/CharaP0135_10.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
