...
function NormalSkin() {
    ...
    if (option.models.value == "CharaP0039_00.skel"){
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0039_03/CharaP0039_03.skel"){
        setNewCostume("CharaP0039_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0039_50/CharaP0039_50.skel"){
        setNewCostume("CharaP0039_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0039_51/CharaP0039_51.skel"){
        setNewCostume("CharaP0039_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
...
function Skin1() {
    setNewCostume("/CharaP0039_03/CharaP0039_03.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
...
function Skin2() {
    setNewCostume("/CharaP0039_50/CharaP0039_50.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
...
function Skin3() {
    setNewCostume("/CharaP0039_51/CharaP0039_51.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
