...
function NormalSkin() {
    ...
    if (option.models.value == "CharaP0197_00.skel"){
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "CharaP0197_08/CharaP0197_08.skel"){
        setNewCostume("CharaP0197_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
...
function Skin1() {
    setNewCostume("CharaP0197_08/CharaP0197_08.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
