...
function NormalSkin() {
    ...
    if (option.models.value == "CharaP0103_00.skel"){
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0103a_00/CharaP0103a_00.skel"){
        setNewCostume("CharaP0103_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
...
function SExeggutor() {
    setNewCostume("/CharaP0103a_00/CharaP0103a_00.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
...
function RedClerk() {
    ...
    if(option.models.value == "CharaP0103_00.skel"){
        if (checkBox.checked = true){
            ...
            char.skeleton.findSlot("Color_Cap3").color.setFromString("D44626")
...
function GreenClerk() {
    ...
    if(option.models.value == "CharaP0103_00.skel"){
        if (checkBox.checked = true){
            ...
            char.skeleton.findSlot("Color_Cap3").color.setFromString("7BBEB4")
...
function YellowClerk() {
    ...
    if(option.models.value == "CharaP0103_00.skel"){
        if (checkBox.checked = true){
            ...
            char.skeleton.findSlot("Color_Cap3").color.setFromString("F7D300")
...
function BrownClerk() {
    ...
    if(option.models.value == "CharaP0103_00.skel"){
        if (checkBox.checked = true){
            ...
            char.skeleton.findSlot("Color_Cap3").color.setFromString("BF8539")
...
function BlueClerk() {
    ...
    if(option.models.value == "CharaP0103_00.skel"){
        if (checkBox.checked = true){
            ...
            char.skeleton.findSlot("Color_Cap3").color.setFromString("0097D9")
    ...
    if(option.models.value == "/CharaP0038b_03/CharaP0038b_03.skel"){
        if (checkBox.checked = true){
            NormalSkin()
            setTimeout(function() {
                setDefaultSkin("ClerkCostume");
...
function PinkClerk() {
    ...
    if(option.models.value == "CharaP0103_00.skel"){
        if (checkBox.checked = true){
            ...
            char.skeleton.findSlot("Color_Cap3").color.setFromString("EAC3CC")
...
function GreyClerk() {
    ...
    if(option.models.value == "CharaP0103_00.skel"){
        if (checkBox.checked = true){
            ...
            char.skeleton.findSlot("Color_Cap3").color.setFromString("ABAEAD")
...
function PurpleClerk() {
    ...
    if(option.models.value =="CharaP0103_00.skel"){
        if (checkBox.checked = true){
            ...
            char.skeleton.findSlot("Color_Cap3").color.setFromString("72629C")
...
function OrangeClerk() {
    ...
    if(option.models.value == "CharaP0103_00.skel"){
        if (checkBox.checked = true){
            ...
            char.skeleton.findSlot("Color_Cap3").color.setFromString("F0A300")
...
function BlackClerk() {
    ...
    if(option.models.value == "CharaP0103_00.skel"){
        if (checkBox.checked = true){
            ...
            char.skeleton.findSlot("Color_Cap3").color.setFromString("524D4E")
