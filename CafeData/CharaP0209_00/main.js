...
function NormalSkin() {
    ...
    if (option.models.value == "CharaP0209_00.skel"){
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0209_50/CharaP0209_50.skel"){
        setNewCostume("CharaP0209_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0209a_00/CharaP0209a_00.skel"){
        setNewCostume("CharaP0209_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0209a_50/CharaP0209a_50.skel"){
        setNewCostume("CharaP0209_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
...
function Skin1() {
    setNewCostume("/CharaP0209_50/CharaP0209_50.skel");
    setTimeout(function() {
...
function SNormalSkin() {
    setNewCostume("/CharaP0209a_00/CharaP0209a_00.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
function SSkin1() {
    setNewCostume("/CharaP0209a_50/CharaP0209a_50.skel");
    setTimeout(function() {
        setDefaultSkin("ClerkCostume");
    }, 300);
}
