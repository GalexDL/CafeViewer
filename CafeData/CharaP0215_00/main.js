...
function NormalSkin() {
    ...
    if (option.models.value == "CharaP0215_00.skel"){
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0215_50/CharaP0215_50.skel"){
        setNewCostume("CharaP0215_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0215a_00/CharaP0215a_00.skel"){
        setNewCostume("CharaP0215_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0215a_50/CharaP0215a_50.skel"){
        setNewCostume("CharaP0215_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
...
function Skin1() {
    setNewCostume("/CharaP0215_50/CharaP0215_50.skel");
    setTimeout(function() {
...
function SNormalSkin() {
    setNewCostume("/CharaP0215a_00/CharaP0215a_00.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
function SSkin1() {
    setNewCostume("/CharaP0215a_50/CharaP0215a_50.skel");
    setTimeout(function() {
        setDefaultSkin("ClerkCostume");
    }, 300);
}
