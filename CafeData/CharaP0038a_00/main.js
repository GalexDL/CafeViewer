...
//
function NormalSkin() {
    if (option.models.value == "/CharaP0038a_03/CharaP0038a_03.skel"){
        setNewCostume("CharaP0038a_00.skel")
        setTimeout(function() {
    ...
    if (option.models.value == "CharaP0038a_00.skel"){
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
...
function ANinetalesHoliday() {
    setNewCostume("/CharaP0038a_03/CharaP0038a_03.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}

function SANinetalesHoliday() {
    setNewCostume("/CharaP0038b_03/CharaP0038b_03.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
