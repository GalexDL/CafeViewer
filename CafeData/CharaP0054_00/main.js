...
function NormalSkin() {
    ...
    if (option.models.value == "CharaP0054_00.skel"){
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0054_50/CharaP0054_50.skel"){
        setNewCostume("CharaP0054_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
...
function PsyduckSR() {
    setNewCostume("/CharaP0054_50/CharaP0054_50.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
