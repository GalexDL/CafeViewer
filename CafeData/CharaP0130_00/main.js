...
function NormalSkin() {
    ...
    if (option.models.value == "CharaP0130_00.skel"){
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0130a_00/CharaP0130a_00.skel"){
        setNewCostume("CharaP0130_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
...
function SGyarados() {
    setNewCostume("/CharaP0130a_00/CharaP0130a_00.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
