...
function NormalSkin() {
    ...
    if (option.models.value == "CharaP0132_00.skel"){
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0132_50/CharaP0132_50.skel"){
        setNewCostume("CharaP0132_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0132_51/CharaP0132_51.skel"){
        setNewCostume("CharaP0132_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
...
function DittoPika() {
    setNewCostume("/CharaP0132_50/CharaP0132_50.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
...
function DittoEevee() {
    setNewCostume("/CharaP0132_51/CharaP0132_51.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}

function DittoDragonite() {
    setNewCostume("/CharaP0132_52/CharaP0132_52.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
