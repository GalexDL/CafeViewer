...
//
function NormalSkin() {
    if (option.models.value == "/CharaP0037_17/CharaP0037_17.skel"){
        setNewCostume("CharaP0026a_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0037_50/CharaP0037_50.skel"){
        setNewCostume("CharaP0026a_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0037a_00/CharaP0026a_00.skel"){
        setNewCostume("CharaP0026a_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0037a_12/CharaP0037a_12.skel"){
        setNewCostume("CharaP0026a_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0037a_50/CharaP0037a_50.skel"){
        setNewCostume("CharaP0026a_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0025_07/CharaP0025_07.skel"){
        setNewCostume("CharaP0026a_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0025_12/CharaP0025_12.skel"){
        setNewCostume("CharaP0026a_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0025_50/CharaP0025_50.skel"){
        setNewCostume("CharaP0026a_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0025_51/CharaP0025_51.skel"){
        setNewCostume("CharaP0026a_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0025_52/CharaP0025_52.skel"){
        setNewCostume("CharaP0026a_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
...
function Clerk() {
    ...
    if(option.models.value = "/CharaP0037a_00/CharaP0026a_00.skel"){
        if (checkBox.checked == false){
            setNewCostume("/CharaP0037_17/CharaP0037_17.skel")
            setTimeout(function() {
                setDefaultSkin("ClerkCostume");
            }, 300);
        }
...
function RedClerk() {
    ...
    if(option.models.value = "CharaP0026a_00.skel"){
        if (checkBox.checked == true){
            setDefaultSkin("ClerkCostume");
            //Scarf
            char.skeleton.findSlot("Color_Scarf1").color.setFromString("D44626")
            char.skeleton.findSlot("Color_Scarf2").color.setFromString("D44626")
    ...
    if(option.models.value = "CharaP0026a_00.skel"){
        if (checkBox.checked == true){
            setTimeout(function() {
                setDefaultSkin("ClerkCostume");
                //Scarf
                char.skeleton.findSlot("Color_Scarf1").color.setFromString("7BBEB4")
                char.skeleton.findSlot("Color_Scarf2").color.setFromString("7BBEB4")
    ...
    if(option.models.value =="CharaP0026a_00.skel"){
        if (checkBox.checked == true){
            ...
            setTimeout(function() {
                setDefaultSkin("ClerkCostume");
                //Scarf
                char.skeleton.findSlot("Color_Scarf1").color.setFromString("F7D300")
                char.skeleton.findSlot("Color_Scarf2").color.setFromString("F7D300")
    ...
    if(option.models.value =="CharaP0026a_00.skel"){
        if (checkBox.checked == true){
            ...
            setTimeout(function() {
                setDefaultSkin("ClerkCostume");
                //Scarf
                char.skeleton.findSlot("Color_Scarf1").color.setFromString("BF8539")
                char.skeleton.findSlot("Color_Scarf2").color.setFromString("BF8539")
    ...
    if(option.models.value =="CharaP0026a_00.skel"){
        if (checkBox.checked == true){
            ...
            setTimeout(function() {
                setDefaultSkin("ClerkCostume");
                //Scarf
                char.skeleton.findSlot("Color_Scarf1").color.setFromString("0097D9")
                char.skeleton.findSlot("Color_Scarf2").color.setFromString("0097D9")
    ...
    if(option.models.value =="CharaP0026a_00.skel"){
        if (checkBox.checked == true){
            ...
            setTimeout(function() {
                setDefaultSkin("ClerkCostume");
                //Scarf
                char.skeleton.findSlot("Color_Scarf1").color.setFromString("EAC3CC")
                char.skeleton.findSlot("Color_Scarf2").color.setFromString("EAC3CC")
    ...
    if(option.models.value =="CharaP0026a_00.skel"){
        if (checkBox.checked == true){
            ...
            setTimeout(function() {
                setDefaultSkin("ClerkCostume");
                //Scarf
                char.skeleton.findSlot("Color_Scarf1").color.setFromString("ABAEAD")
                char.skeleton.findSlot("Color_Scarf2").color.setFromString("ABAEAD")
    ...
    if(option.models.value =="CharaP0026a_00.skel"){
        if (checkBox.checked == true){
            ...
            setTimeout(function() {
                setDefaultSkin("ClerkCostume");
                //Scarf
                char.skeleton.findSlot("Color_Scarf1").color.setFromString("72629C")
                char.skeleton.findSlot("Color_Scarf2").color.setFromString("72629C")
    ...
    if(option.models.value =="CharaP0026a_00.skel"){
        if (checkBox.checked == true){
            ...
            setTimeout(function() {
                setDefaultSkin("ClerkCostume");
                //Scarf
                char.skeleton.findSlot("Color_Scarf1").color.setFromString("F0A300")
                char.skeleton.findSlot("Color_Scarf2").color.setFromString("F0A300")
    ...
    if(option.models.value =="CharaP0026a_00.skel"){
        if (checkBox.checked = true){
            ...
            setTimeout(function() {
                setDefaultSkin("ClerkCostume");
                //Scarf
                char.skeleton.findSlot("Color_Scarf1").color.setFromString("524D4E")
                char.skeleton.findSlot("Color_Scarf2").color.setFromString("524D4E")
