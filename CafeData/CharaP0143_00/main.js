...
function NormalSkin() {
    ...
    if (option.models.value == "CharaP0143_00.skel"){
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
    if (option.models.value == "/CharaP0143_50/CharaP0143_50.skel"){
        setNewCostume("CharaP0143_00.skel")
        setTimeout(function() {
            setDefaultSkin("Normal");
        }, 300);
    }
...
function Skin1() {
    setNewCostume("/CharaP0143_50/CharaP0143_50.skel");
    setTimeout(function() {
        setDefaultSkin("Normal");
    }, 300);
}
